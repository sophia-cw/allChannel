...
$(function () {
	...
	[].forEach.call(document.querySelectorAll(".indexArticle .txt p a,aside .artileListBox li a,.articleList > ul > li .txt p,section.mainBox .interestBox li p a"), function(elem) {
	    ellipsisText(elem);
	});
	...
	var cookiebarH = $("#cookie-bar").outerHeight();
	var realHeight =  WINDOWh-cookiebarH;
	console.log(cookiebarH,realHeight);
	if ($("nav").hasClass("index") && WINDOWw >= 1000){
		
	} else {
		$(".cookieShow nav").css("height",realHeight);
		$(".cookieShow.nocookie nav").css("height","100%");
	};
